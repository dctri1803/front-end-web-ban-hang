...
import { CustomCheckbox, WrapperCountOrder, WrapperHeader, WrapperInfo, WrapperInputNumber, WrapperItemOrder, WrapperLeft, WrapperListOrder, WrapperRight, WrapperStyleHeader, WrapperStyleHeaderDilivery, WrapperTotal } from './style'
...
import { decreaseAmount, increaseAmount, removeAllOrderProduct, removeOrderProduct, selectedOrder, setAmount } from '../../features/slice/orderSlice'
...
export const OrderPage = () => {
  ...
  const handleSetCount = (value, idProduct) => {
    if (value >= 1) {
      dispatch(setAmount({ idProduct, amount: value }))
    }
  }
                  ...
                  <WrapperItemOrder key={order?.product}>
                    ...
                    <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                      ...
                      <WrapperCountOrder>
                        ...
                        <WrapperInputNumber defaultValue={order?.amount} value={order?.amount} size="small" min={1} max={order.countInStock} onChange={(value) => handleSetCount(value, order?.product)} />
