...
export const { addOrderProduct, resetOrder, increaseAmount, decreaseAmount, setAmount, removeOrderProduct, removeAllOrderProduct, selectedOrder } = orderSlice.actions
